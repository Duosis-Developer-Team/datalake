\restrict DGtkJLU1KG98VZA9evEwOKQCVPixdWuJEqSsdvEzBzyUQeSD8jxhHRyNJwdKbI8
CREATE TABLE public.raw_vmware_datacenter_metrics_agg (
...
CREATE INDEX raw_vmware_datacenter_metrics_agg_collection_timestamp_idx ON public.raw_vmware_datacenter_metrics_agg USING btree (collection_timestamp DESC);
CREATE TRIGGER ts_insert_blocker BEFORE INSERT ON public.raw_vmware_datacenter_metrics_agg FOR EACH ROW EXECUTE FUNCTION _timescaledb_functions.insert_blocker();
\unrestrict DGtkJLU1KG98VZA9evEwOKQCVPixdWuJEqSsdvEzBzyUQeSD8jxhHRyNJwdKbI8
