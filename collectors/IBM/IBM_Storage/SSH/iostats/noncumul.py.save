...
Nd_fields = ["ro", "wo", "rb", "wb", "re", "we", "rq", "wq" ,"ure", "uwe", "urq", "uwq", "pre", "pwe", "pro", "pwo"]
Nv_fields = ["ro", "wo", "rb", "wb", "re", "we", "rq", "wq" ,"ure", "uwe", "urq", "uwq", "pre", "pwe", "pro", "pwo"]
Nm_fields = ["ro", "wo", "rb", "wb", "re", "we", "rq", "wq" ,"ure", "uwe", "urq", "uwq", "pre", "pwe", "pro", "pwo"]
Nn_fields = ["ro", "wo", "rb", "wb", "re", "we", "rq", "wq" ,"ure", "uwe", "urq", "uwq", "pre", "pwe", "pro", "pwo"]
    ...
    for parent in root.findall(rootname):
        ...
        if idx_value:
            ...
            for attr_name, val_str in parent.attrib.items():
                if (typ == "Nd"): 
                    fields = ["ro", "wo", "rb", "wb", "re", "we", "rq", "wq" ,"ure", "uwe", "urq", "uwq", "pre", "pwe", "pro", "pwo"]
                elif (typ == "Nm"): 
                    fields = ["ro", "wo", "rb", "wb", "re", "we", "rq", "wq" ,"ure", "uwe", "urq", "uwq", "pre", "pwe", "pro", "pwo"]
                elif (typ == "Nv"): 
                    fields = ["ro", "wo", "rb", "wb", "re", "we", "rq", "wq" ,"ure", "uwe", "urq", "uwq", "pre", "pwe", "pro", "pwo"]
