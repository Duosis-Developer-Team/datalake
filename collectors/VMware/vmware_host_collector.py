        ...
        for datacenter in content.rootFolder.childEntity:
            ...
            for entity in datacenter.hostFolder.childEntity:
                ...
                for host in entity.host:
                    # Extract all data types for this host
                    all_records.append(extract_host_hardware(host, vcenter_uuid, collection_timestamp, hierarchy))
                    all_records.append(extract_host_runtime(host, vcenter_uuid, collection_timestamp))
                    all_records.extend(extract_host_storage(host, vcenter_uuid, collection_timestamp))
