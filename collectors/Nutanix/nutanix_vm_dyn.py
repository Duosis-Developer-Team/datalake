...
parser = argparse.ArgumentParser(
    description='Fetch Nutanix VM stats via Prism API (arguments instead of config file)'
)
parser.add_argument(
    '--prism-ips',
    required=True,
...
# Argümanlardan gelen değerleri değişkenlere ata
prism_ip_string = args.prism_ips
if prism_ip_string:
